insert into public.restaurant_settings (restaurant_name, tagline, description, description_en, logo_url, background_image_url, primary_color, accent_color, currency, font_key, theme_mode, language, service_enabled)
values (
  'Verde Bistro',
  'Taze, sakin ve hızlı',
  'Mevsim ürünleriyle hazırlanan yemekler, kahveler ve tatlılar. Masadan sipariş verin, biz hazırlayalım.',
...
insert into public.tables (name, table_code) values
  ('Masa 1', 'masa-1'),
  ('Masa 2', 'masa-2'),
  ('Bahçe 1', 'bahce-1');

insert into public.categories (name, name_en, description, description_en, sort_order) values
...
insert into public.menu_items (category_id, name, name_en, description, description_en, price, image_url, calories, carbs, protein, fat, sort_order)
select categories.id, menu_data.name, menu_data.name_en, menu_data.description, menu_data.description_en, menu_data.price, menu_data.image_url, menu_data.calories, menu_data.carbs, menu_data.protein, menu_data.fat, menu_data.sort_order
from menu_data
